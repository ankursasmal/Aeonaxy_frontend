...
function Blog() {
  ...
  <a className={` self-start p-4 text-[7.3vw]  `} style={{ fontFamily: "Domine, serif !important",lineHeight:'6.5vw'
}}>Learn more
about us. Or
join us.</a>
...
<div className=' col-span-1 flex  flex-col self-start '>
...
and creatives of all stripes.</a>
      <button className='text-green-400 border-green-400 mx-7 border-[1px] sm:mt-[1vw] mt-[4vw]   rounded-full  self-start px-[2vw] py-[.5vw] sm:text-[.5vw] mb-8'>View open positions</button>       
